...
export class BasePage implements IBasePage{
    ...
    constructor(page: Page) {
        ...
        this.headerSignInButton = this.page.getByTestId('login-button');
        ...
        this.harmburgerMenuMobile = this.page.getByTestId('harmburger-menu-mobile');
        this.closeHarmburgerMenuMobile = this.page.getByTestId('close-harmburger-menu-mobile');
        this.orderStatus = this.page.getByTestId('order-status');
    ...
    async clickHarmburgerMenuMobile(): Promise<void>{
        await this.harmburgerMenuMobile.click();
    };

    async clickCloseHarmburgerMenuMobile(): Promise<void>{
        await this.closeHarmburgerMenuMobile.click();
    };
